...
On the subway, skipping the tap-out is obvious — the gate won't open. On a bus, nothing stops you from just walking off without tapping again. Nothing beeps, no one checks. But the transfer discount (subway ↔ bus, or bus ↔ bus, within the transfer window) only applies if you tap out — so skip it and you silently pay full fare on your *next* ride instead of the discounted transfer rate, with zero indication anything went wrong.
